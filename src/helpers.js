...
<div class="hdr">
  ...
  <div style="text-align:right"><strong>GRN: ${data.grn_number || "PENDING"}</strong><br><small>${new Date().toLocaleDateString('en-GB')}</small></div>
</div>
...
<div class="sigs">
  <div class="sig"><p>Officer: ${officer.name||"________"}</p></div>
  <div class="sig"><p>Supplier Signature</p></div>
  <div class="sig"><p>Verified By</p></div>
</div>
